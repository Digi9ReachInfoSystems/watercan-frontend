...
// import { Container, Title, StyledTable, ModalContent, ButtonGroup, FilterContainer } from "./AdminPayment.styles";
...
//             p.key === selectedPayment.key ? { ...p, status: "Approved" } : p
//         ));
...
//     const handleReject = () => {
//         setPayments(payments.map(p => 
//             p.key === selectedPayment.key ? { ...p, status: "Rejected" } : p
//         ));
//         setIsModalOpen(false);
//     };
...
//                     min={1} 
//                     value={newTransaction.waterCans} 
//                     onChange={(value) => setNewTransaction({ ...newTransaction, waterCans: value })} 
//                 />
